...
func TestApplyContainerResourceMetricOverride(t *testing.T) {
	...
	if err := simulate.ApplyContainerResourceMetricOverride(hpa, spec, 0, "80%"); err != nil {
	...
	if err := simulate.ApplyContainerResourceMetricOverride(hpa, spec, 0, "not-a-number"); err == nil {
	...
	if err := simulate.ApplyContainerResourceMetricOverride(hpa, avSpec, 0, "500Mi"); err != nil {
...
func TestApplyObjectMetricOverride(t *testing.T) {
	...
	if err := simulate.ApplyObjectMetricOverride(hpa, avgSpec, 0, "12"); err != nil {
	...
	if err := simulate.ApplyObjectMetricOverride(hpa, valSpec, 0, "9"); err != nil {
	...
	if err := simulate.ApplyObjectMetricOverride(hpa, valSpec, 0, "oops"); err == nil {
...
func TestCapacityObservationDomain(t *testing.T) {
	...
	for _, tt := range tests {
		got := CapacityObservationDomainForError(CapacityObservationError{Source: tt.source})
		if got != tt.want {
	...
	got := CapacityObservationDomainForError(CapacityObservationError{
