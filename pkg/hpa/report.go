...
func WriteMarkdownReport(w io.Writer, report StatusReport) error {
	...
	appendMarkdownHeader(&out, report.Analysis)
	appendMarkdownSummary(&out, report.Analysis)
	appendMarkdownConditions(&out, report.Analysis)
	appendMarkdownMetrics(&out, report.Analysis)
	appendMarkdownActions(&out, report.Analysis)
	appendMarkdownSuggestions(&out, report.Analysis)
	appendMarkdownEvents(&out, report)
	appendMarkdownPodAnalysis(&out, report.Analysis)
	appendMarkdownSimulation(&out, report.Analysis)
	appendMarkdownMetricFreshness(&out, report.Analysis)
	appendMarkdownCapacityContext(&out, report.Analysis)
	appendMarkdownStructuredDecisionTrace(&out, report.Analysis)
