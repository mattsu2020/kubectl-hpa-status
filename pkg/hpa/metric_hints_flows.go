...
func buildFlow(h MetricHint) *MetricHintTroubleshooting {
	base := MetricHintTroubleshooting{
		Pattern:    h.Pattern,
		Severity:   h.Severity,
		Title:      h.Title,
	...
	switch h.Pattern {
	case "external-metric-missing":
		base.Steps = []MetricHintFix{
			{
				StepNumber:     1,
	...
	case "custom-api-service-unavailable":
		base.Steps = []MetricHintFix{
			{
				StepNumber:     1,
	...
	case "external-api-service-unavailable":
		base.Steps = []MetricHintFix{
			{
				StepNumber:     1,
	...
	case "object-metric-target-not-found":
		base.Steps = []MetricHintFix{
			{
				StepNumber:     1,
