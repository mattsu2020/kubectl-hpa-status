// Package healthtrend analyzes health score history over time: trend
// statistics, flapping detection, anomaly detection, sparklines, and ASCII
// graph rendering. It was extracted from the pkg/hpa analysis core to keep
// the root package focused on single-HPA analysis.
package healthtrend
