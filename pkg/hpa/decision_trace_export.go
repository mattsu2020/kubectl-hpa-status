...
func resolveStructuredWinner(hpa *autoscalingv2.HorizontalPodAutoscaler, a Analysis, metrics []StructuredMetricTrace) (string, Confidence) {
	if a.Decision.MetricDecisionTrace != nil && a.Decision.MetricDecisionTrace.Winner != "" {
		return a.Decision.MetricDecisionTrace.Winner, a.Decision.MetricDecisionTrace.WinnerConfidence
	}
...
func buildStructuredStabilizationTrace(hpa *autoscalingv2.HorizontalPodAutoscaler, a Analysis) *StabilizationTrace {
	...
	direction := "scaleDown"
	if a.Conditions.StabilizationSource != "" {
		direction = a.Conditions.StabilizationSource
	}
