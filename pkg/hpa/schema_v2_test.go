...
func TestProjectStatusReportV2UsesFrozenCanonicalSnapshot(t *testing.T) {
	report := StatusReport{APIVersion: SchemaVersion, Analysis: Analysis{
		Meta:     MetaView{Name: "before"},
		Decision: DecisionView{Health: "OK"},
	}}
	report.FreezeCanonical()
	report.Analysis.Meta.Name = "legacy-mutated"
	projected := ProjectStatusReportV2(report)
