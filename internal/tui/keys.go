...
type keyMap struct {
	...
	DryRun         key.Binding
	IntervalFaster key.Binding
	IntervalSlower key.Binding
...
func defaultKeys() keyMap {
	...
	return keyMap{
		...
		DryRun: b([]string{"d"}, "d", "server dry-run"), IntervalFaster: b([]string{"+", "="}, "+/=", "faster refresh"), IntervalSlower: b([]string{"-"}, "-", "slower refresh"),
