...
func TestRunStatus_ExplainPods_JSON(t *testing.T) {
	...
	_ = report.Analysis.Capacity.PodAnalysis
}
...
func TestRunStatus_Simulate(t *testing.T) {
	...
	if report.Analysis.Stability.FlappingSimulation.Parameter != "maxReplicas" {
		t.Errorf("expected parameter=maxReplicas, got %q", report.Analysis.Stability.FlappingSimulation.Parameter)
	}
	if report.Analysis.Stability.FlappingSimulation.OriginalValue != "10" {
		t.Errorf("expected originalValue=10, got %q", report.Analysis.Stability.FlappingSimulation.OriginalValue)
	}
	if report.Analysis.Stability.FlappingSimulation.SimulatedValue != "20" {
		t.Errorf("expected simulatedValue=20, got %q", report.Analysis.Stability.FlappingSimulation.SimulatedValue)
	}
}
