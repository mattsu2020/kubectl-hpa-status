...
func writeBundleCapacityContextSection(b *Writer, data *Data) {
	...
	cc := data.StatusReport.Analysis.Capacity.CapacityContext
	if cc == nil {
...
func writeBundleScalePathSection(b *Writer, data *Data) {
	b.Print("## Scale Path\n\n")
	sp := data.StatusReport.Analysis.Capacity.ScalePath
	if sp == nil {
...
func writeBundleBlockerSection(b *Writer, data *Data) {
	...
	br := data.StatusReport.Analysis.Blockers.BlockerReport
	if br == nil {
